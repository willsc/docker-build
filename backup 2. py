...
def main():
    ...
    #   - If --full is specified, force full backup.
    #   - If --incremental is specified, force incremental backup.
    #   - Otherwise, perform a full backup on the 1st day of the month, incremental otherwise.
    if args.full:
    ...
    for host in config["hosts"]:
        ...
        for fs in host["filesystems"]:
            ...
            if archive_enabled:
                ...
                # If archiving is disabled, use a temporary file.
